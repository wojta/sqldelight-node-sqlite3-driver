...
external fun lookupService(address: String, port: Number): Promise<`T$21`>

external fun resolve(hostname: String): Promise<Array<String>>

external fun resolve(hostname: String, rrtype: String /* "A" | "AAAA" | "ANY" | "CAA" | "CNAME" | "MX" | "NAPTR" | "NS" | "PTR" | "SOA" | "SRV" | "TXT" */): dynamic /* Promise */
...
external fun resolveCaa(hostname: String): Promise<Array<CaaRecord>>
