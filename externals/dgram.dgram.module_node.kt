...
external open class Socket : EventEmitter {
    ...
    open fun bind(port: Number = definedExternally, address: String = definedExternally, callback: () -> Unit = definedExternally): Socket /* this */
    open fun bind(): Socket /* this */
    open fun bind(port: Number = definedExternally): Socket /* this */
    open fun bind(port: Number = definedExternally, address: String = definedExternally): Socket /* this */
    open fun bind(port: Number = definedExternally, callback: () -> Unit = definedExternally): Socket /* this */
    open fun bind(callback: () -> Unit = definedExternally): Socket /* this */
    open fun bind(options: BindOptions, callback: () -> Unit = definedExternally): Socket /* this */
    open fun bind(options: BindOptions): Socket /* this */
    open fun close(callback: () -> Unit = definedExternally): Socket /* this */
    open fun connect(port: Number, address: String = definedExternally, callback: () -> Unit = definedExternally)
    open fun connect(port: Number)
    open fun connect(port: Number, address: String = definedExternally)
    ...
    open fun send(msg: String, port: Number = definedExternally)
    open fun send(msg: String, port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun send(msg: Uint8Array)
    open fun send(msg: Uint8Array, port: Number = definedExternally)
    open fun send(msg: Uint8Array, port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun send(msg: Array<Any>)
    open fun send(msg: Array<Any>, port: Number = definedExternally)
    open fun send(msg: Array<Any>, port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun send(msg: String, offset: Number, length: Number)
    open fun send(msg: String, offset: Number, length: Number, port: Number = definedExternally)
    open fun send(msg: String, offset: Number, length: Number, port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun send(msg: Uint8Array, offset: Number, length: Number)
    open fun send(msg: Uint8Array, offset: Number, length: Number, port: Number = definedExternally)
    open fun send(msg: Uint8Array, offset: Number, length: Number, port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun setMulticastLoopback(flag: Boolean): Boolean
    open fun setMulticastTTL(ttl: Number): Number
    open fun setRecvBufferSize(size: Number)
    open fun setSendBufferSize(size: Number)
    open fun setTTL(ttl: Number): Number
