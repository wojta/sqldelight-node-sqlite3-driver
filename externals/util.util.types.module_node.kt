...
external fun <T> isMap(obj: T): Boolean

external fun <T> isMap(obj: Any): Boolean
...
external fun <T> isSet(obj: T): Boolean

external fun <T> isSet(obj: Any): Boolean
...
external fun isKeyObject(obj: Any): Boolean

external fun isCryptoKey(obj: Any): Boolean