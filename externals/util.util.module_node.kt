...
external fun inspect(obj: Any, options: InspectOptions = definedExternally): String
...
external open class TextDecoder(encoding: String = definedExternally, options: `T$62` = definedExternally) {
    open var encoding: String
    open var fatal: Boolean
    open var ignoreBOM: Boolean
    open fun decode(input: Uint8Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(): String
    open fun decode(input: Uint8Array? = definedExternally): String
    open fun decode(input: Uint8ClampedArray? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Uint8ClampedArray? = definedExternally): String
    open fun decode(input: Uint16Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Uint16Array? = definedExternally): String
    open fun decode(input: Uint32Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Uint32Array? = definedExternally): String
    open fun decode(input: Int8Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Int8Array? = definedExternally): String
    open fun decode(input: Int16Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Int16Array? = definedExternally): String
    open fun decode(input: Int32Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Int32Array? = definedExternally): String
    open fun decode(input: BigUint64Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: BigUint64Array? = definedExternally): String
    open fun decode(input: BigInt64Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: BigInt64Array? = definedExternally): String
    open fun decode(input: Float32Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Float32Array? = definedExternally): String
    open fun decode(input: Float64Array? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: Float64Array? = definedExternally): String
    open fun decode(input: DataView? = definedExternally, options: `T$63` = definedExternally): String
    open fun decode(input: DataView? = definedExternally): String
    open fun decode(input: ArrayBuffer? = definedExternally, options: `T$63` = definedExternally): String
