...
external var writer: REPLWriter /* REPLWriter & `T$73` */
...
external open class REPLServer : Interface {
    ...
    open var input: ReadableStream
    open var output: WritableStream
    ...
    open fun setupHistory(path: String, callback: (err: Error?, repl: REPLServer /* this */) -> Unit)
