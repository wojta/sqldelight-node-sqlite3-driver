...
external open class Session : EventEmitter {
    open fun connect()
    open fun connectToMainThread()
    open fun disconnect()
    open fun post(method: String, params: Any = definedExternally, callback: (err: Error?, params: Any) -> Unit = definedExternally)
    open fun post(method: String /* "Schema.getDomains" | "Runtime.evaluate" | "Runtime.evaluate" | "Runtime.awaitPromise" | "Runtime.awaitPromise" | "Runtime.callFunctionOn" | "Runtime.callFunctionOn" | "Runtime.getProperties" | "Runtime.getProperties" | "Runtime.releaseObject" | "Runtime.releaseObject" | "Runtime.releaseObjectGroup" | "Runtime.releaseObjectGroup" | "Runtime.runIfWaitingForDebugger" | "Runtime.enable" | "Runtime.disable" | "Runtime.discardConsoleEntries" | "Runtime.setCustomObjectFormatterEnabled" | "Runtime.setCustomObjectFormatterEnabled" | "Runtime.compileScript" | "Runtime.compileScript" | "Runtime.runScript" | "Runtime.runScript" | "Runtime.queryObjects" | "Runtime.queryObjects" | "Runtime.globalLexicalScopeNames" | "Runtime.globalLexicalScopeNames" | "Debugger.enable" | "Debugger.disable" | "Debugger.setBreakpointsActive" | "Debugger.setBreakpointsActive" | "Debugger.setSkipAllPauses" | "Debugger.setSkipAllPauses" | "Debugger.setBreakpointByUrl" | "Debugger.setBreakpointByUrl" | "Debugger.setBreakpoint" | "Debugger.setBreakpoint" | "Debugger.removeBreakpoint" | "Debugger.removeBreakpoint" | "Debugger.getPossibleBreakpoints" | "Debugger.getPossibleBreakpoints" | "Debugger.continueToLocation" | "Debugger.continueToLocation" | "Debugger.pauseOnAsyncCall" | "Debugger.pauseOnAsyncCall" | "Debugger.stepOver" | "Debugger.stepInto" | "Debugger.stepInto" | "Debugger.stepOut" | "Debugger.pause" | "Debugger.scheduleStepIntoAsync" | "Debugger.resume" | "Debugger.getStackTrace" | "Debugger.getStackTrace" | "Debugger.searchInContent" | "Debugger.searchInContent" | "Debugger.setScriptSource" | "Debugger.setScriptSource" | "Debugger.restartFrame" | "Debugger.restartFrame" | "Debugger.getScriptSource" | "Debugger.getScriptSource" | "Debugger.setPauseOnExceptions" | "Debugger.setPauseOnExceptions" | "Debugger.evaluateOnCallFrame" | "Debugger.evaluateOnCallFrame" | "Debugger.setVariableValue" | "Debugger.setVariableValue" | "Debugger.setReturnValue" | "Debugger.setReturnValue" | "Debugger.setAsyncCallStackDepth" | "Debugger.setAsyncCallStackDepth" | "Debugger.setBlackboxPatterns" | "Debugger.setBlackboxPatterns" | "Debugger.setBlackboxedRanges" | "Debugger.setBlackboxedRanges" | "Console.enable" | "Console.disable" | "Console.clearMessages" | "Profiler.enable" | "Profiler.disable" | "Profiler.setSamplingInterval" | "Profiler.setSamplingInterval" | "Profiler.start" | "Profiler.stop" | "Profiler.startPreciseCoverage" | "Profiler.startPreciseCoverage" | "Profiler.stopPreciseCoverage" | "Profiler.takePreciseCoverage" | "Profiler.getBestEffortCoverage" | "Profiler.startTypeProfile" | "Profiler.stopTypeProfile" | "Profiler.takeTypeProfile" | "HeapProfiler.enable" | "HeapProfiler.disable" | "HeapProfiler.startTrackingHeapObjects" | "HeapProfiler.startTrackingHeapObjects" | "HeapProfiler.stopTrackingHeapObjects" | "HeapProfiler.stopTrackingHeapObjects" | "HeapProfiler.takeHeapSnapshot" | "HeapProfiler.takeHeapSnapshot" | "HeapProfiler.collectGarbage" | "HeapProfiler.getObjectByHeapObjectId" | "HeapProfiler.getObjectByHeapObjectId" | "HeapProfiler.addInspectedHeapObject" | "HeapProfiler.addInspectedHeapObject" | "HeapProfiler.getHeapObjectId" | "HeapProfiler.getHeapObjectId" | "HeapProfiler.startSampling" | "HeapProfiler.startSampling" | "HeapProfiler.stopSampling" | "HeapProfiler.getSamplingProfile" | "NodeTracing.getCategories" | "NodeTracing.start" | "NodeTracing.start" | "NodeTracing.stop" | "NodeWorker.sendMessageToWorker" | "NodeWorker.sendMessageToWorker" | "NodeWorker.enable" | "NodeWorker.enable" | "NodeWorker.disable" | "NodeWorker.detach" | "NodeWorker.detach" | "NodeRuntime.notifyWhenWaitingForDisconnect" | "NodeRuntime.notifyWhenWaitingForDisconnect" */)
    open fun post(method: String, params: Any = definedExternally)
    ...
    open fun post(method: String /* "Runtime.evaluate" */, params: EvaluateParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.awaitPromise" */, params: AwaitPromiseParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.callFunctionOn" */, params: CallFunctionOnParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.getProperties" */, params: GetPropertiesParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.releaseObject" */, params: ReleaseObjectParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.releaseObjectGroup" */, params: ReleaseObjectGroupParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.setCustomObjectFormatterEnabled" */, params: SetCustomObjectFormatterEnabledParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.compileScript" */, params: CompileScriptParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.runScript" */, params: RunScriptParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.queryObjects" */, params: QueryObjectsParameterType = definedExternally)
    ...
    open fun post(method: String /* "Runtime.globalLexicalScopeNames" */, params: GlobalLexicalScopeNamesParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setBreakpointsActive" */, params: SetBreakpointsActiveParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setSkipAllPauses" */, params: SetSkipAllPausesParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setBreakpointByUrl" */, params: SetBreakpointByUrlParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setBreakpoint" */, params: SetBreakpointParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.removeBreakpoint" */, params: RemoveBreakpointParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.getPossibleBreakpoints" */, params: GetPossibleBreakpointsParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.continueToLocation" */, params: ContinueToLocationParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.pauseOnAsyncCall" */, params: PauseOnAsyncCallParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.stepInto" */, params: StepIntoParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.getStackTrace" */, params: GetStackTraceParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.searchInContent" */, params: SearchInContentParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setScriptSource" */, params: SetScriptSourceParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.restartFrame" */, params: RestartFrameParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.getScriptSource" */, params: GetScriptSourceParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setPauseOnExceptions" */, params: SetPauseOnExceptionsParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.evaluateOnCallFrame" */, params: EvaluateOnCallFrameParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setVariableValue" */, params: SetVariableValueParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setReturnValue" */, params: SetReturnValueParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setAsyncCallStackDepth" */, params: SetAsyncCallStackDepthParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setBlackboxPatterns" */, params: SetBlackboxPatternsParameterType = definedExternally)
    ...
    open fun post(method: String /* "Debugger.setBlackboxedRanges" */, params: SetBlackboxedRangesParameterType = definedExternally)
    ...
    open fun post(method: String /* "Profiler.setSamplingInterval" */, params: SetSamplingIntervalParameterType = definedExternally)
    ...
    open fun post(method: String /* "Profiler.startPreciseCoverage" */, params: StartPreciseCoverageParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.startTrackingHeapObjects" */, params: StartTrackingHeapObjectsParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.stopTrackingHeapObjects" */, params: StopTrackingHeapObjectsParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.takeHeapSnapshot" */, params: TakeHeapSnapshotParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.getObjectByHeapObjectId" */, params: GetObjectByHeapObjectIdParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.addInspectedHeapObject" */, params: AddInspectedHeapObjectParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.getHeapObjectId" */, params: GetHeapObjectIdParameterType = definedExternally)
    ...
    open fun post(method: String /* "HeapProfiler.startSampling" */, params: StartSamplingParameterType = definedExternally)
    ...
    open fun post(method: String /* "NodeTracing.start" */, params: StartParameterType = definedExternally)
    ...
    open fun post(method: String /* "NodeWorker.sendMessageToWorker" */, params: SendMessageToWorkerParameterType = definedExternally)
    ...
    open fun post(method: String /* "NodeWorker.enable" */, params: EnableParameterType = definedExternally)
    ...
    open fun post(method: String /* "NodeWorker.detach" */, params: DetachParameterType = definedExternally)
    ...
    open fun post(method: String /* "NodeRuntime.notifyWhenWaitingForDisconnect" */, params: NotifyWhenWaitingForDisconnectParameterType = definedExternally)
