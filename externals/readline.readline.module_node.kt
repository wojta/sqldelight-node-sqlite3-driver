...
external open class Interface : EventEmitter {
    ...
    constructor(input: ReadableStream, output: WritableStream = definedExternally)
    constructor(input: ReadableStream, output: WritableStream = definedExternally, completer: Completer = definedExternally)
    ...
    constructor(input: ReadableStream, output: WritableStream = definedExternally, completer: AsyncCompleter = definedExternally)
    ...
    open fun question(query: String, options: Abortable, callback: (answer: String) -> Unit)
    ...
    open fun write(data: Buffer)
    open fun write(data: String?, key: Key)
    open fun write(data: Buffer?, key: Key)
    ...
    open fun addListener(event: String /* "history" */, listener: (history: Array<String>) -> Unit): Interface /* this */
    ...
    override fun emit(eventName: String, vararg args: Any): Boolean
    override fun emit(eventName: Any, vararg args: Any): Boolean
    open fun emit(event: String /* "history" */, history: Array<String>): Boolean
    ...
    open fun on(event: String /* "history" */, listener: (history: Array<String>) -> Unit): Interface /* this */
    ...
    open fun once(event: String /* "history" */, listener: (history: Array<String>) -> Unit): Interface /* this */
    ...
    open fun prependListener(event: String /* "history" */, listener: (history: Array<String>) -> Unit): Interface /* this */
    ...
    open fun prependOnceListener(event: String /* "history" */, listener: (history: Array<String>) -> Unit): Interface /* this */
}
...
external fun createInterface(input: ReadableStream, output: WritableStream = definedExternally): Interface

external fun createInterface(input: ReadableStream, output: WritableStream = definedExternally, completer: Completer = definedExternally): Interface
...
external fun createInterface(input: ReadableStream, output: WritableStream = definedExternally, completer: AsyncCompleter = definedExternally): Interface
...
external fun clearLine(stream: WritableStream, dir: String /* "-1" */): Boolean

external fun clearLine(stream: WritableStream, dir: Number /* 0 | 1 */, callback: () -> Unit = definedExternally): Boolean

external fun clearLine(stream: WritableStream, dir: Number /* 0 | 1 */): Boolean
