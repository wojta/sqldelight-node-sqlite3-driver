...
import net.TcpSocketConnectOpts
...
external open class IncomingMessage(socket: Socket) : Readable {
    ...
    open var statusCode: Number?
    open var statusMessage: String?
    override fun destroy(error: Error): IncomingMessage /* this */
}

external interface AgentOptions : Partial<TcpSocketConnectOpts> {
