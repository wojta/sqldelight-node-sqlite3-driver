...
external open class WriteStream(fd: Number) : Socket {
    ...
    open fun clearLine(dir: String /* "-1" */): Boolean
    open fun clearLine(dir: Number /* 0 | 1 */, callback: () -> Unit = definedExternally): Boolean
    open fun clearLine(dir: Number /* 0 | 1 */): Boolean
    ...
    open fun cursorTo(x: Number): Boolean
    open fun cursorTo(x: Number, y: Number = definedExternally): Boolean
    ...
    open fun hasColors(count: Number = definedExternally): Boolean
    open fun hasColors(): Boolean
    open fun hasColors(env: Any? = definedExternally): Boolean
    open fun hasColors(count: Number, env: Any? = definedExternally): Boolean
