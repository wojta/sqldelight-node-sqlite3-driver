...
external fun lookup(hostname: String, options: LookupOptions, callback: (err: ErrnoException?, address: Any /* String | Array<LookupAddress> */, family: Number) -> Unit)
...
external fun resolve(hostname: String, rrtype: String /* "ANY" */, callback: (err: ErrnoException?, addresses: Array<Any /* AnyARecord | AnyAaaaRecord | AnyCnameRecord | AnyMxRecord | AnyNaptrRecord | AnyNsRecord | AnyPtrRecord | AnySoaRecord | AnySrvRecord | AnyTxtRecord */>) -> Unit)
...
external fun resolve(hostname: String, rrtype: String, callback: (err: ErrnoException?, addresses: Any /* Array<String> | Array<MxRecord> | Array<NaptrRecord> | SoaRecord | Array<SrvRecord> | Array<Array<String>> | Array<dynamic /* AnyARecord | AnyAaaaRecord | AnyCnameRecord | AnyMxRecord | AnyNaptrRecord | AnyNsRecord | AnyPtrRecord | AnySoaRecord | AnySrvRecord | AnyTxtRecord */> */) -> Unit)
...
external fun resolve4(hostname: String, options: ResolveOptions, callback: (err: ErrnoException?, addresses: Any /* Array<String> | Array<RecordWithTtl> */) -> Unit)
...
external fun resolve6(hostname: String, options: ResolveOptions, callback: (err: ErrnoException?, addresses: Any /* Array<String> | Array<RecordWithTtl> */) -> Unit)

external fun resolveCname(hostname: String, callback: (err: ErrnoException?, addresses: Array<String>) -> Unit)

external fun resolveCaa(hostname: String, callback: (err: ErrnoException?, records: Array<CaaRecord>) -> Unit)
...
external fun resolveAny(hostname: String, callback: (err: ErrnoException?, addresses: Array<Any /* AnyARecord | AnyAaaaRecord | AnyCnameRecord | AnyMxRecord | AnyNaptrRecord | AnyNsRecord | AnyPtrRecord | AnySoaRecord | AnySrvRecord | AnyTxtRecord */>) -> Unit)
...
external fun setDefaultResultOrder(order: String /* "ipv4first" | "verbatim" */)
...
external open class Resolver(options: ResolverOptions = definedExternally) {
    open fun cancel()
    ...
    open fun setLocalAddress(ipv4: String = definedExternally, ipv6: String = definedExternally)
