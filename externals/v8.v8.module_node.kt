...
external open class Serializer {
    ...
    open fun writeRawBytes(buffer: BigUint64Array)
    open fun writeRawBytes(buffer: BigInt64Array)
...
external fun deserialize(buffer: Uint8Array): Any

external fun deserialize(buffer: Uint8ClampedArray): Any

external fun deserialize(buffer: Uint16Array): Any

external fun deserialize(buffer: Uint32Array): Any

external fun deserialize(buffer: Int8Array): Any

external fun deserialize(buffer: Int16Array): Any

external fun deserialize(buffer: Int32Array): Any

external fun deserialize(buffer: BigUint64Array): Any

external fun deserialize(buffer: BigInt64Array): Any

external fun deserialize(buffer: Float32Array): Any

external fun deserialize(buffer: Float64Array): Any
