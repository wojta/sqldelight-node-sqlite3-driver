...
external open class TLSSocket(socket: Socket, options: TLSSocketOptions = definedExternally) : Socket {
    ...
    open var alpnProtocol: dynamic /* String? | Boolean? */
    ...
    open fun getPeerCertificate(): dynamic /* PeerCertificate */
    ...
    open fun getPeerX509Certificate(): X509Certificate?
    ...
    override fun addListener(event: String /* "OCSPResponse" | "session" | "keylog" */, listener: (response: Buffer) -> Unit): TLSSocket /* this */
    ...
    override fun on(event: String /* "OCSPResponse" | "session" | "keylog" */, listener: (response: Buffer) -> Unit): TLSSocket /* this */
    ...
    override fun once(event: String /* "OCSPResponse" | "session" | "keylog" */, listener: (response: Buffer) -> Unit): TLSSocket /* this */
    ...
    override fun prependListener(event: String /* "OCSPResponse" | "session" | "keylog" */, listener: (response: Buffer) -> Unit): TLSSocket /* this */
    ...
    override fun prependOnceListener(event: String /* "OCSPResponse" | "session" | "keylog" */, listener: (response: Buffer) -> Unit): TLSSocket /* this */
...
external interface TlsOptions : SecureContextOptions, CommonConnectionOptions, ServerOpts {
    var handshakeTimeout: Number?
        get() = definedExternally
        set(value) = definedExternally
    override var sessionTimeout: Number?
        get() = definedExternally
        set(value) = definedExternally
...
external interface PSKCallbackNegotation {
    var psk: dynamic /* DataView | Uint8Array | Uint8ClampedArray | Uint16Array | Uint32Array | Int8Array | Int16Array | Int32Array | BigUint64Array | BigInt64Array | Float32Array | Float64Array */
        get() = definedExternally
        set(value) = definedExternally
    var identity: String
}
...
external open class Server : net.Server {
    ...
    open fun addContext(hostname: String, context: SecureContextOptions)
    open fun getTicketKeys(): Buffer
    open fun setSecureContext(options: SecureContextOptions)
...
external fun createServer(options: TlsOptions): Server

external fun connect(options: ConnectionOptions, secureConnectListener: () -> Unit = definedExternally): TLSSocket

external fun connect(options: ConnectionOptions): TLSSocket
...
external fun connect(port: Number, host: String = definedExternally): TLSSocket

external fun connect(port: Number, host: String = definedExternally, options: ConnectionOptions = definedExternally): TLSSocket
...
external fun connect(port: Number, options: ConnectionOptions = definedExternally): TLSSocket
