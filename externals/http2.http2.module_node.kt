...
external interface ServerHttp2Session : Http2Session {
    ...
    fun origin(vararg origins: Any /* String | url.URL | `T$71` */)
...
external open class Http2ServerResponse(stream: ServerHttp2Stream) : Writable {
    ...
    override fun end(callback: () -> Unit): Http2ServerResponse /* this */
    override fun end(): Http2ServerResponse /* this */
    override fun end(data: String, callback: () -> Unit): Http2ServerResponse /* this */
    override fun end(data: String): Http2ServerResponse /* this */
    override fun end(data: Uint8Array, callback: () -> Unit): Http2ServerResponse /* this */
    override fun end(data: Uint8Array): Http2ServerResponse /* this */
    override fun end(data: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: () -> Unit): Http2ServerResponse /* this */
    override fun end(data: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Http2ServerResponse /* this */
    open fun end(data: Uint8Array, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: () -> Unit = definedExternally): Http2ServerResponse /* this */
    override fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, cb: () -> Unit): Writable /* this */
    open fun end(data: Uint8Array, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Http2ServerResponse /* this */
    override fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Writable /* this */
